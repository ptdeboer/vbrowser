...
// * ---
// * $Id: TaskMonitorPanel.java,v 1.4 2013/01/23 13:10:12 piter Exp $  
// * $Date: 2013/01/23 13:10:12 $
// */ 
//// source: 
//
...
//import nl.nlesc.ptk.task.ITaskMonitor.TaskStats;
//import nl.nlesc.ptk.task.MonitorStats;
...
//
//    private UIPresentation presentation=UIPresentation.createDefault(); 
...
//        TaskStats subStats = taskMonitor.getSubTaskStats(subTask); 
//        
//        // Master Task: 
...
//                        +StatsUtil.timeString(this.monitorStats.getTotalDoneDeltaTime(),false)); 
//            }
//        }
//        else
//        {
...
//                if (todo>0)
//                {
//                    double value=(double)subStats.done/(double)todo; 
...
//    {
//        String timestr=StatsUtil.timeString(monitorStats.getTotalDoneTime(),false);
//        
...
//        	timestr+= " (done)";
//        else
//        	timestr+=" ("+StatsUtil.timeString(eta,false)+")";
//        
//        return timestr; 
//        
//    }
...
//        	    finalStr+=" ("+speedStr+")"; 
//        	
//        	finalStr+=" in "+StatsUtil.timeString(monitorStats.getTotalDoneTime(),false);
//        	
//        	return finalStr; 
//        }
//       
...
//    {
//    	ITaskMonitor info=taskMonitor; 
//    	String subTask=info.getCurrentSubTaskName();
//    	
//        String progstr="";
//        
//        if (info.isDone())
...
//        TaskStats subStats = info.getSubTaskStats(subTask);
//        
//        if ((subStats==null) || (subStats.todo<=0))
//        {
//            progstr="(?) ";
//        }
//        else
//        {
//            progstr+=percentage3(subStats.done,subStats.todo)+"% ";
//        }
//        
//        long delta=subStats.doneLastUpdateTimeMillies-subStats.startTimeMillies;
//        
//        if (delta<=0) 
//            delta=1;
//        
