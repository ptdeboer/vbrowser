 ...
 * ---
 * $Id: ActionCommand.java,v 1.3 2013/01/23 10:39:57 piter Exp $  
...
//    }
    ...
    private void parse(String actionStr)
    {
        ...
        {
            UILogger.errorPrintf(this,"Warning: Empty or NULL Command:%s\n",actionStr);
            return; 
        }
	...
	public VRSFactory getVRS()
	{
		if (vrs==null)
		{
	          ...
	          if (this.vrs==null)
	              UILogger.errorPrintf(this,"*** Internal Error: Could find VRS with name:%s\n",vrsname); 
