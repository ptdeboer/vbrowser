...
// * ---
// * $Id: SubTaskPanel.java,v 1.3 2013/01/23 13:10:12 piter Exp $  
...
//               {
//                   UILogger.errorPrintf(this,"Interrupted!\n"); 
//                } 
//            }
//            
...
//                     if ((i%10)==0)
//                     {
//                         monitor.startSubTask(subTaskName,10);
//                     }
//                     
//                     monitor.updateSubTaskDone(subTaskName,i%10); 
//                     
//                     // panel.setProgress(i); 
...
//            str+=" in "+StatsUtil.timeString(monitorStats.getTotalDoneTime(),false);
//        	
//        	return str; 
//        }
//         
...
//        
//        
//        long delta=info.getTaskStats().doneLastUpdateTimeMillies-info.getStartTime(); 
//        if (delta<=0) 
//        	delta=1; 
//        
...
//        String subTaskName=info.getCurrentSubTaskName(); 
//        TaskStats subStats = info.getSubTaskStats(subTaskName); 
//        
//        if (subStats.todo<=0)
//        {
//            progstr="(?) ";
...
//            delta=1; 
//        
//        progstr+=sizeString(subStats.done)+" "
//            +"("+subStats.done/delta+"Work/s)";
//                 
//        return progstr;
//    }
//
