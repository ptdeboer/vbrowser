 ...
 * ---
 * $Id: BrowserInteractiveActions.java,v 1.5 2013/01/24 13:39:24 piter Exp $  
...
import nl.nlesc.vlet.gui.actions.DummyTransferWatcher;
import nl.nlesc.vlet.gui.data.ResourceRef;
import nl.nlesc.vlet.gui.dialog.CopyDialog;
import nl.nlesc.vlet.gui.dialog.SimpleDialog;
import nl.nlesc.vlet.gui.dialog.SimpleNButtonDialog;
import nl.nlesc.vlet.gui.dialog.CopyDialog.CopyOption;
        ...
        ActionTask task = new ActionTask(browserController, "CopyMoveDrop #"+sources.length+" sources to:"+targetPNode.getVRL() )
        {
            public void doTask() 
            {
                ...
                try
                {
                    ...
                    {
                        throw new nl.nlesc.vlet.exception.ResourceTypeMismatchException("Cannot perform drop on: target destination:"+destNode);
                    }
                }
                catch (Throwable t)
                {
