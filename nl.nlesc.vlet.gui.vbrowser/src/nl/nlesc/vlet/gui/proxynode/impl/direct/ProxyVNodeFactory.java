 ...
 * ---
 * $Id: ProxyVNodeFactory.java,v 1.2 2013/01/23 16:05:09 piter Exp $  
       ...
       throws VlException
    {
        ...
        synchronized(pnode)
        {
            ...
            if ((pnode.vnode==null) || (pnode.mustrefresh))
            {
                ...
                if (pnode.vnode==null)
                	throw new nl.nlesc.vlet.exception.ResourceNotFoundException("Got NULL Node. Couldn't get node:"+loc); 
            ...
            if ((pnode.isResourceLink()) && (resolveLinks))
            {
                ...
                if (pnode.vnode==null)
                	throw new nl.nlesc.vlet.exception.ResourceNotFoundException("Couldn't resolve LinkNode:"+loc); 
            }
