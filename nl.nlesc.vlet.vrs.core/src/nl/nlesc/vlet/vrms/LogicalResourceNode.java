...
public class LogicalResourceNode extends VNode implements 
   ...
   VLogicalResource,VResourceLink,VPersistance,VDuplicatable<LogicalResourceNode>,IPresentable
{
   ...
   public String getPersistantType()
   {
    ...
    public VAttribute checkAttribute(VAttribute attr) 
    {
        ...
        else if (name.compareTo(ATTR_SCHEME)==0)
        {
            ...
            {
                editable=Global.getRootLogger().isLevelDebug();// // when in debug mode, make this editable ! 
            }
            else
            {
