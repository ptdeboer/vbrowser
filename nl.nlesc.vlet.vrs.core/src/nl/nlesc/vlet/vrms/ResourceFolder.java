...
import nl.nlesc.vlet.vrs.VDuplicatable;
        ...
        VDuplicatable<ResourceFolder>, VDeletable, VCompositeDeletable, VStreamReadable, IPresentable
{
    ...
    protected void addSubNode(VNode node) throws VlException
    {
        ...
        if ((node instanceof VLogicalResource) == false)
            throw new nl.nlesc.vlet.exception.ResourceTypeMismatchException("Node type not supported:" + node);
    ...
    public static ResourceFolder createFrom(VNode sourceNode) throws Exception
    {
        ...
        throw new nl.nlesc.vlet.exception.ResourceTypeMismatchException("Not a ResourceFolder description:" + sourceNode);
    }
