...
//    }
  ...
  //=========================================================================
     ...
     */
    public List<ResourceTreeNode> findNodes(VRI locator)
    {
    ...
    protected List<ResourceTreeNode> findNodes(List<ResourceTreeNode> nodes, ResourceTreeNode node, VRI locator)
    {
        // check parent: 
