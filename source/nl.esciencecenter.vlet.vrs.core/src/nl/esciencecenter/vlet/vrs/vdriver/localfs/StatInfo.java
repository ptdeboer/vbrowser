...
//    { FILENAME, SIZE, USERID, USERNAME, GROUPID, GROUPNAME, MODE, MODTIME, ATIME, ULINK, LINK };
//
//    public static String getUxStatString()
//    {
//        String statstr = FILENAME + "=%n;" + TYPE + "=%F;" + USERID + "=%u;" + USERNAME + "=%U;" + GROUPID + "=%g;"
//                + GROUPNAME + "=%G;" + SIZE + "=%s;" + MODTIME + "=%Y;" + ATIME + "=%X;" + MODE + "=%a;" + PERMISSIONS
//                + "=%A;" + ULINK + "=%h;" + LINK + "=%N;";
//        return statstr;
//    }
//
...
//
//    /**
//     * Parse "{NAME=VALUE;}*" String. Space and other strange characters between
//     * '=' and ';' are considered part of the value. Newlines will be filtered
//     * out.
//     */
...
//            String value = strs[1];
//
//            if ((StringUtil.isEmpty(name) == false) && (StringUtil.isEmpty(value) == false))
//            {
