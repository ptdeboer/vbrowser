 ...
 * For pre VRSContext and global settings, see: {@link nl.esciencecenter.vlet.VletConfig}. 
 * <p> 
...
//                    bdiiInfos.add(index++,info);  //inserts before system settings, but keep order. 
    ...
    public URI getBdiiServiceURI() throws InitializationException
    {
        ...
        if ((infos==null) || (infos.size()<=0))
        {
            throw new nl.esciencecenter.vlet.exception.InitializationException("No BDII service information found!");
        }
    ...
    /** @see nl.esciencecenter.vlet.VletConfig#isService() */ 
     ...
     * @see nl.esciencecenter.vlet.VletConfig#PROP_ALLOW_USER_INTERACTION PROP_ALLOW_USER_INTERACTION
     */   
