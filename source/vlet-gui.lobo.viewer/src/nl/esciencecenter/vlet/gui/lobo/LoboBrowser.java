...
package nl.esciencecenter.vlet.gui.lobo;
...
public class LoboBrowser extends ViewerPlugin 
{
    ...
    static
    {
        try
        {
            VRS.getRegistry().registerVRSDriverClass(nl.esciencecenter.vlet.gui.lobo.resfs.ResFS.class);
        }
        catch (Exception e)
        {
...
//	    }
	...
	public void updateLocation(VRL vrl) throws VrsException
	{
        ...
        try
        {
            if (vrl.hasScheme(VRS.HTTPS_SCHEME))
            {
