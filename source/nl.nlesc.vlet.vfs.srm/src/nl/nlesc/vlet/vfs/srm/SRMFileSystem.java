...
//    }
   ...
   // private static Object globalSRMConnectMutex=new Object(); 
    ...
    public VDir createDir(String name, boolean force) throws VrsException
    {
        ...
        throw new nl.nlesc.vlet.exception.ResourceCreationFailedException("Could not create " + fullpath);
    }
    ...
    public VFile doActiveTransfer(ITaskMonitor monitor, VRL sourceLocation, SRMFile targetFile) throws VrsException
    {
        ...
        // no methods left:
        throw new nl.nlesc.vlet.exception.ResourceTypeNotSupportedException("Cannot handle third party transfer from:"
                + sourceLocation);
    ...
    public VFile doTransfer(ITaskMonitor monitor, SRMFile sourceFile, VRL targetLocation) throws VrsException
    {
        ...
        if ((isGFTP(turl)) && (isSRM(targetLocation)))
        {
            ...
            {
                // srm location should result in SRM File:
                throw new nl.nlesc.vlet.exception.ResourceTypeNotSupportedException("SRM Location is not an SRM file:"
                        + targetLocation);
            }
        }
        ...
        throw new nl.nlesc.vlet.exception.ResourceTypeNotSupportedException("Cannot handle 3rd party transfer to:"
                + targetLocation);
