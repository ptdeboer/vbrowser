...
import nl.esciencecenter.vlet.util.bdii.BdiiException;
...
public class LFCClient
{
    ...
    public InputStream getInputStream(ITaskMonitor monitor, LFCFile path) throws VrsException
    {
        ...
        {
            throw new nl.esciencecenter.vlet.exception.ResourceReadException("File doesn't have any replicas:" + path);
        }
        ...
        throw new nl.esciencecenter.vlet.exception.ResourceReadException(
    ...
    public boolean deleteReplica(ITaskMonitor monitor, LFCFile file, String storageElement) throws VrsException
    {
        ...
        catch (nl.esciencecenter.vlet.exception.ResourceNotFoundException e)
        {
    ...
    public void deleteFromSE(VNode node, boolean recurse) throws VrsException
    {
        ...
        {
            throw new nl.esciencecenter.vlet.exception.ResourceDeletionFailedException("Faild to delete " + node
                    + ". Resource is not a file or directory");
        }
    ...
    public String getComment(String path) throws VrsException
    {
        ...
        catch (LFCException e)
        {
            if (!exists(path, new BooleanHolder()))
            {
                throw new nl.esciencecenter.vlet.exception.ResourceNotFoundException("Resource Not Found in: " + path);
            }
            else
            {
