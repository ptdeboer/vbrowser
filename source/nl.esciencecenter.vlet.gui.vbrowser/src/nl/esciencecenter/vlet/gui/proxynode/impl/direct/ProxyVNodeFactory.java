        ...
        synchronized(pnode)
        {
            ...
            if ((pnode.vnode==null) || (pnode.mustrefresh))
            {
                ...
                catch (Throwable t)
                {
                	...
                	throw new nl.esciencecenter.vlet.exception.ResourceNotFoundException("Couldn't get node:"+loc
                	        +"\n"+t.getMessage(),t);
                }
                
                if (pnode.vnode==null)
                	throw new nl.esciencecenter.vlet.exception.ResourceNotFoundException("Got NULL Node. Couldn't get node:"+loc); 
            ...
            if ((pnode.isResourceLink()) && (resolveLinks))
            {
                ...
                if (pnode.vnode==null)
                	throw new nl.esciencecenter.vlet.exception.ResourceNotFoundException("Couldn't resolve LinkNode:"+loc); 
            }
    ...
    { 
        ...
        synchronized (nodeHash)
        {
            ...
            if (prev!=null)
            {
                ...
                UILogger.debugPrintf(ProxyVNode.class,"*** Warning: Node already in cache:%s\n",pnode); 
            }
        }
