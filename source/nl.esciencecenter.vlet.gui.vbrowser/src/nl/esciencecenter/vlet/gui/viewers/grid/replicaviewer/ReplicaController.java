...
import nl.esciencecenter.vlet.gui.panels.list.StatusStringListField;
...
public class ReplicaController implements ActionListener, ListSelectionListener, ListDataListener
{
    ...
    private boolean checkUpdateLFCSizeFromReplicas() throws Exception
    {
    ...
    {
        if ((loc==null) || (StringUtil.isEmpty(loc.toString())) ) 
        {
            editor.clearAll();
            return;
        }
            ...
            public void doTask()
            {
                ...
                try
                {
                    ...
                    for (VRL repVrl : vrls)
                    {
                        ...
                        if (this.isCancelled() == true)
                        {
                            UILogger.warnPrintf(this, "Update Task stopped!\n");
                            break;
                        }
