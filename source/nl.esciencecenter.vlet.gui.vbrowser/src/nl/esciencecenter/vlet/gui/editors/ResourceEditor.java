...
package nl.esciencecenter.vlet.gui.editors;
...
import nl.esciencecenter.vlet.gui.panels.fields.AttrCheckBoxField;
import nl.esciencecenter.vlet.gui.panels.fields.AttrParameterField;
import nl.esciencecenter.vlet.gui.panels.fields.AttrPortField;
import nl.esciencecenter.vlet.gui.panels.fields.AttrSchemeField;
import nl.esciencecenter.vlet.gui.panels.fields.IAttributeField;
...
public class ResourceEditor extends javax.swing.JDialog
{
    ...
    private JComponent getTypeField()
    {
        if (typeField == null)
        {
            typeField = createAttributeField(VAttributeConstants.ATTR_RESOURCE_TYPE, "<TYPE>",
                    this.controller.getAttributeListener());
        }
        return typeField;
    }
