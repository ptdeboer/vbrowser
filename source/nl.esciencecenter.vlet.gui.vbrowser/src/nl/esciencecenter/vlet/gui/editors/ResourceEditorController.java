...
import static nl.esciencecenter.vlet.vrs.data.VAttributeConstants.ATTR_DIRNAME;
...
public class ResourceEditorController implements ActionListener, WindowListener, ITaskSource
{
    ...
    {
        UILogger.errorPrintf(this,"Error:%s\n",msg); 
    }
    ...
    private void bgUpdateNode(final ProxyNode pnode)
    {
        ...
        attrs.set(ATTR_RESOURCE_TYPE,pnode.getType());
    ...
    private void _bgUpdateNode(ProxyNode pnode)
    {
        ...
        try
        {
         ...
         // apply attribute and signal refresh ! 
            ...
            if (attrs.get(ATTR_RESOURCE_TYPE)==null)
            	attrs.set(ATTR_RESOURCE_TYPE,pnode.getType());
	...
	protected  ServerInfo fetchServerInfo(boolean autoCreate) 
    {
		...
		{
		    UILogger.warnPrintf(this,"***Warning: Empty scheme for:%s!\n",this.locationVrl);
		    return null; 
		}
