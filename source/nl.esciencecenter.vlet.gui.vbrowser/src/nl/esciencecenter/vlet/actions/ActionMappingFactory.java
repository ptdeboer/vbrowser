...
import static nl.esciencecenter.vlet.actions.ActionMenuConstants.*;
...
public class ActionMappingFactory
{
    public static Vector<ActionMenuMapping> createTestMenus()
    {
        ...
        mapping.addTypeMapping(types); // ,null,null,ActionMenuConstants.SELECTION_DONT_CARE);
    ...
    /**
     * Create simple Type based actionMenuMapping where actionName is the action
     * performed, actionMenuItem the item name appearing in the action menu, and
     * the 'type' is the specified type of the resource.
     * 
     * @param actionName
     *            Action Performed
     * @param actionMenuItemName
     *            Menu Item name which will appear in the menu
     * @param type
     *            Resource Type the node must have for this action menu item.
     * @return ActionMenuMapping
     */
    public ActionMenuMapping createTypeMenuMapping(String actionName, String actionMenuItemName, String type)
    {
        Vector<ActionMenuMapping> mappings = new Vector<ActionMenuMapping>();
    ...
    /**
     * Create simple Type based ActionMenuMapping where actionName is the action
     * performed and actionMenuItem the item name appearing in the action menu.
     ...
     *            Menu Item name which will appear in the menu.
     * @param types
     *            Resource Types the node must have for this action menu item.
     * @return ActionMenuMapping.
     */
    public ActionMenuMapping createTypeMenuMapping(String actionName, String actionMenuItemName, String types[])
    {
        Vector<ActionMenuMapping> mappings = new Vector<ActionMenuMapping>();
     ...
     * action performed and actionMenuItem the item name appearing in the action
     * menu. This menu mapping will match all node which type is one of 'types'.
     * 
     * @param actionName
     *            Action Performed.
     * @param actionMenuItemName
     *            Menu Item name which will appear in the menu.
     * @param types
     *            One of the allowed Resource Types for this action menu item.
     * @param scheme
     *            Resource Scheme the node must have.
     * @return ActionMenuMapping.
     */
    public ActionMenuMapping createTypeMenuMapping(String actionName, String actionMenuItemName, String types[],
            String scheme)
     ...
     * @return ActionMenuMapping
     */
    public ActionMenuMapping createTypeSchemeMenuMapping(String actionName, String actionMenuItemName, String types[],
            String schemes[])
    {
        Vector<ActionMenuMapping> mappings = new Vector<ActionMenuMapping>();
     ...
     *            One of the allowed Resource Types for this action menu item.
     * @param selectionMode
     *            Extra selection conditions which determine menu mapping.
     * @return ActionMenuMapping
     */
    public ActionMenuMapping createTypeSchemeMenuMapping(String actionName, String actionMenuItemName, String types[],
            String schemes[], int selectionMode)
    {
        Vector<ActionMenuMapping> mappings = new Vector<ActionMenuMapping>();
