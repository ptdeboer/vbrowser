...
package nl.esciencecenter.vlet.gui.util.proxy;
...
import nl.esciencecenter.vlet.exception.ProxyCredentialException;
...
class GridProxyDialogController implements ActionListener, WindowListener, FocusListener
{
    ...
    protected void proxyCreated()
    {
        ...
        Throwable ex=proxyCreationTask.getException();
        VO vo=null;
        
        // test get Provider! 
        try 
        {
            gridProxy.getProvider();
        } 
        catch (Throwable e) 
        {
        ...
        if (ex!=null)
        {
        	...
        	if ((ex instanceof nl.esciencecenter.vlet.exception.UnknownCAException) && (vo!=null)) 
        	{
        		// ExceptionForm.show(this.proxyDialog,ex,true);
