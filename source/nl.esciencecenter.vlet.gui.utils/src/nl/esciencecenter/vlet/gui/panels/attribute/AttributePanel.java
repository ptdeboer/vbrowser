...
import nl.esciencecenter.vlet.gui.panels.fields.AttrEnumField;
import nl.esciencecenter.vlet.gui.panels.fields.AttrIntField;
...
public class AttributePanel extends JPanel
{
    ...
    public void setAttributes(AttributeSet orgSet, boolean editable)
    {
        ...
        for (int i=0;i<len;i++)
        {
            ...
            )
            {
                ...
                if (vals==null)
                {
                    UILogger.errorPrintf(this,"Error no enumvalues for attribute:%s\n",attr.getName()); 
                    vals=new String[1]; 
                    vals[0]="<NULL>";
                }
    ...
    public void setAttribute(String name, String value) 
    {
        ...
        {
            UILogger.debugPrintf(this,"Attribute not found:%s\n",name);
        }
