...
import static nl.esciencecenter.vlet.actions.ActionMenuConstants.MENU_INACTIVE_DONT_SHOW;
import static nl.esciencecenter.vlet.actions.ActionMenuConstants.MENU_ITEM_ACTION;
 ...
 * 
 * Used by the VBrowser to dynamically determine which 'action' may apear on the
 * Action Menu/Canvas Menu. <br>
 * When a right mouse button click is performed (or <i>alt</i> mouse button
 * click) ON an item, the Item Menu will appear. A right mouse button click (or
 * <i>alt</i> mouse button click) on the canvas of a composite node (directory)
 * will show the Canvas Menu.<br>
 * 
 * @author P.T. de Boer
 */
public class ActionMenuMapping
{
     ...
     * 
     * @param actionName
     *            action name which will be supplied when invoking
     *            VRS.doAction()
     * @param actionMenuItemName
     *            the name to appear in the action menu
     * @param options
     *            Menu Options
     */
    ...
    /*
     * public void setMenuSettings(String actionName,String actionMenuName,int
     * options) { init(actionName,actionMenuName,null,options); }
     * 
     * public void setMenuSettings(String actionName,String
     * actionMenuName,String subMenuName,int options) {
     ...
     * named by this name. The VBrowser will automatically create the named
     * submenu and add all ActionMappings hich have the same submenu name
     * merging all actions into the same (named) submenu.
     */
    ...
    /**
     * Add Mapping for the speficied Resource Type. If the selected resource has
    ...
    public void addTypeMapping(String type)
    {
        ...
        this.resourcePatterns.add(new ResourceMappingPatterns(this, types, null, null, null,
                ActionMenuConstants.SELECTION_DONT_CARE));
    }
    ...
    public void addSelectionTypeMapping(String type)
    {
        ...
        this.resourcePatterns.add(new ResourceMappingPatterns(this, null, null, types, null,
                ActionMenuConstants.SELECTION_ONE_OR_MORE));
    }

    /**
     * Add Selection + Type mapping. IF the VBrowser has an active selection
     * which contains the specified type, this menu mapping will be activated.
     * 
     * @param type
     *            VRS Type as RE Pattern the selected resource must have.
     */
    ...
    {
        this.resourcePatterns.add(new ResourceMappingPatterns(this, null, null, types, schemes,
                ActionMenuConstants.SELECTION_ONE_OR_MORE));
    }
    ...
    /**
     * Add Action Menu Mapping for the specifed resource context. The 'source'
     * is the node clicked on, and the 'selections' are optional nodes selected
     * by the VBrowser or resources in the ClipBoard (copy&paste).
     * 
     * @param sourceTypes
     *            selected resource must have one of these types. If null all
     *            types are matched (Don't care).
     * @param sourceSchemes
     *            selected resource must have on of these schemes. If null all
     *            schemes are matched (Don't care).
     * @param selectionTypes
     *            allowed types which may occur in a VBrowser "selection".
     *            Currently all selected resources must has a type specified by
     *            this parameter. Leave to null if types don't matter.
     * @param selectionSchemes
     *            allowed schemes in the current selection. Leave null for don't
     *            care
     * @param selectionMode
     *            extra condition and settings about the selection mode.
     */

    public void addResourceMapping(String sourceTypes[], String sourceSchemes[], String selectionTypes[],
            String selectionSchemes[], int selectionMode)
    {
        this.resourcePatterns.add(new ResourceMappingPatterns(this, sourceTypes, sourceSchemes, selectionTypes,
                selectionSchemes, selectionMode));
    }

    public void addResourceMapping(Pattern sourceTypes[], Pattern sourceSchemes[], Pattern selectionTypes[],
            Pattern selectionSchemes[], int selectionMode)
    {
        this.resourcePatterns.add(new ResourceMappingPatterns(this, sourceTypes, sourceSchemes, selectionTypes,
                selectionSchemes, selectionMode));
    }
    ...
    {
        this.resourcePatterns.add(ResourceMappingPatterns.createMimeTypeMappings(this, sourceMimeTypes,
                selectionMimeTypes, selectionMode));
    }

    /**
     * Add Mapping for the specified resource Type+Scheme. If the resource has
     * the specified type and scheme, this menu mapping will be activated.
     */
    public void addTypeSchemeMapping(String type, String scheme)
    {
        ...
        this.resourcePatterns.add(new ResourceMappingPatterns(this, types, schemes, null, null,
                ActionMenuConstants.SELECTION_DONT_CARE));
    }

    /**
     * Add Resource Mapping for the specified Resource Types. If the resource
     * has one of the specified types, this menu mapping will be activated.
     */
    ...
    /**
     * Add Resource Mapping for the specified Resource Types and schemes. If the
     * Resource is equal to on of the specified Types and has one of the
     * specified schemes, this menu mapping will be activated. 
     */
    ...
    /**
     * get VRS which supplies the action menu. If NULL, then check
     * IViewerClassName !
     */
