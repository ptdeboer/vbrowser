...
//	}
	...
	public static VrsException getVlException(int code,LFCException e)
	{
		...
		{
			case 2: 
				ex=new nl.esciencecenter.vlet.exception.ResourceNotFoundException(msgstr,e); // No such file or directory 
				break; 
			case 4:
				ex=new nl.esciencecenter.vlet.exception.NestedInterruptedException(msgstr,e); // Interrupted proces 
				break; 
			case 5:
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e);  // I/O Error 
				break; 
			case 6:
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e);  // No such device or address 
				break; 
			case 9:
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e); // Bad File number
				break;
            case 11:
                ex=new nl.esciencecenter.vlet.exception.NestedIOException("LFCException: Bacon not ready. Try again",e);  // Try again ? 
                break;
            case 13:
                ex=new nl.esciencecenter.vlet.exception.ResourceAccessDeniedException(msgstr,e); // Permission denied
                break;
			case 15: 
				ex=new nl.esciencecenter.vlet.exception.NestedIOException("Lego Block device required\n."+msgstr,e);
				break; 
			case 16:
				ex=new nl.esciencecenter.vlet.exception.NestedIOException("Device or resource busy.\n"+msgstr,e);
				break; 
			case 17: 
				ex=new nl.esciencecenter.vlet.exception.ResourceAlreadyExistsException(
						"File/Directory exists or Directory is not empty.\n"+msgstr,e);
				break; 
			case 18: 
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e); // Cross-device link
				break; 
			case 19: 
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e) ; // No such device
				break; 
			case 20: 
				ex=new nl.esciencecenter.vlet.exception.ResourceTypeMismatchException(msgstr,e); // Not a directory
				break; 
			case 21: 
				ex=new nl.esciencecenter.vlet.exception.ResourceTypeMismatchException(msgstr,e); // Is a directory 
				break;  
			case 24: 
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e); // Too many open files
				break;
			case 25: 
				ex=new nl.esciencecenter.vbrowser.vrs.exceptions.VrsException("LFCException: Not a typewriter? o.O.\n"+msgstr,e);
				break; 
			case 26: 
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e); // Text file busy
				break; 
			case 27: 
				ex=new nl.esciencecenter.vlet.exception.ResourceToBigException(msgstr,e); // File to large
				break; 
			case 28: 
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e); // No space left on device 
				break; 
			case 29:  
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e); // Illegal Seek ? 
				break; 
			case 30: 
				ex=new nl.esciencecenter.vlet.exception.VrsResourceException("Read-only file system.\n"+msgstr,e);
				break; 
			case 31: 
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e); // too many links
				break; 
			case 32:
				ex=new nl.esciencecenter.vlet.exception.NestedIOException(msgstr,e); // broken pipe
				break;
			case 34: 
