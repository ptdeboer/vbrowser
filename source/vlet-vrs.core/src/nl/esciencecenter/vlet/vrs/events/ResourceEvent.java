...
public class ResourceEvent implements Serializable
{
    ...
    /**
     * Create resource event with an optional logical Parent VRL. Use this
     * factory method if the logical parent VRL differs from
     * (VRL)resource.getParent()!
     */
    ...
    /**
     * Create Rename event. Both old and new VRLs must be supplies as well a the
     * new name, since the name might not be part of the new VRL!
     * 
     * @return
     */
    ...
    /**
     * Source of the Event. In case of a rename this is the OLD VRL, The new
     * Location can be fetched using getNewVRL().
     */
    ...
    /**
     * Returns Optional Parent VRL is specified. If this is a CHILD_ADDED or
     * CHILD_DELETE Event the parent VRL can be fetched from getSource() and the
     * child VRLs from getChilds(). Returns NULL otherwise
     */
