...
import nl.esciencecenter.vlet.exception.VrsServiceTypeMismatchException;
import nl.esciencecenter.vlet.exception.VrsUnsupportedSchemeException;
...
import nl.esciencecenter.vlet.vrs.vdriver.http.HTTPFactory;
import nl.esciencecenter.vlet.vrs.vdriver.http.HTTPSFactory;
import nl.esciencecenter.vlet.vrs.vfs.VFileSystem;
import nl.esciencecenter.vlet.vrs.vrl.VRLStreamHandlerFactory;
 ...
 * @see nl.esciencecenter.vlet.vrs.VResourceSystem
 * @see nl.esciencecenter.vlet.vrs.VNode
 * @see nl.esciencecenter.vlet.vrs.vfs.VFSFactory
 * @see nl.esciencecenter.vlet.vrs.vfs.VFileSystem
 * @see nl.esciencecenter.vlet.vrs.vfs.VFSNode
 * 
 * @author P.T. de Boer
 */
public final class Registry // todo: change to vrs protected class.
{
    ...
    {
        if (location == null)
            throw new nl.esciencecenter.vlet.exception.InternalError("Location parameter can not be null");

        if (context == null)
            throw new nl.esciencecenter.vlet.exception.InternalError("VRSContext parameter can not be null");
