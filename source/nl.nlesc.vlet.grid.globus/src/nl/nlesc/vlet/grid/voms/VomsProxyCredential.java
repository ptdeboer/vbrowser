 ...
 * ---
 * $Id: VomsProxyCredential.java,v 1.1 2013/02/05 11:27:46 piter Exp $  
 * $Date: 2013/02/05 11:27:46 $
 */
// source: 
 ...
 * 
 * @author Gidon Moont 
 *              - Imperial College London. Original Implementation
 * @author Piter T. de Boer
 *              - Exception handling, logging, tweaking.
 */
public class VomsProxyCredential
{
    ...
    public VomsProxyCredential(GlobusCredential globusCred, VO vo, String command, long lifetime) throws Exception
    {
     ...
     */
    public VomsProxyCredential(GlobusCredential gridProxy, VO vo, String command, int lifetimeInSeconds)
            throws Exception
    {
    ...
    private void init(GlobusCredential gridProxy, VO vo, String command, long lifetime) throws Exception
    {
    ...
    private boolean createAC() throws Exception
    {
        ...
        GSSCredential clientCreds = (GSSCredential) new GlobusGSSCredentialImpl(plainProxy, GSSCredential.INITIATE_ONLY);
        ...
        try
        {
            socket = (GssSocket) GssSocketFactory.getDefault().createSocket(vo.getDefaultHost(), vo.getDefaultPort(),
                    context);
    ...
    {
        ClassLogger.getLogger(VomsProxyCredential.class).errorPrintf(format,args); 
    }
