...
public class testAttribute 
{
    ...
    class TestValues
    {
        ...
        VRL       vrl=newVRI("file:","user","localhost",-1,"/tmp/stuff/","query","fragment"); 
    ...
    private VRL newVRI(String string, String string2, String string3, int i, String string4, String string5,
            String string6)
    {
    ...
    void checkObjectValueType(Attribute attr,Object objValue)
    {
        ...
        switch(type)
        {
            ...
            case VRI:
                try
                {
                    Assert.assertTrue("getDoubleValue() must match native type!",((VRL)objValue).equals(attr.getVRI()) );
                }
                catch (Exception e)
                {
