...
//            Assert.assertEquals("added colon is not ignored.", "file:/etc", local.toString());
    ...
    public void testRelativePaths() throws Exception
    {
        ...
        relvri = new VRL("../subdir");
        loc2 = parent.resolvePath(relvri);
        Assert.assertEquals("resolved VRI turned out wrong", "gftp://hostname/parentpath/subdir", loc2.toString());

        relvri = new VRL("../../subdir");
        loc2 = parent.resolvePath(relvri);
        Assert.assertEquals("resolved VRI turned out wrong", "gftp://hostname/subdir", loc2.toString());
    ...
    public void testResolvePathWithSpaces() throws Exception
    {
        ...
        parent = new VRL("gftp://hostname/parentpath");
        loc2 = parent.resolvePath(path);
        Assert.assertEquals("resolved VRI turned out wrong", "gftp://hostname/parentpath/A Dir/A File", loc2.toString());

        path="../A Dir/A File"; 
        parent = new VRL("gftp://hostname/parentpath");
        loc2 = parent.resolvePath(path);
        Assert.assertEquals("resolved VRI turned out wrong", "gftp://hostname/A Dir/A File", loc2.toString());
