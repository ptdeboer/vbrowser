...
public class ProxyNodeDataSource implements ExtendedDataSource
{
    ...
    public ProxyNode[] getChildProxyItems(VRI locator, int offset, int range, LongHolder numChildsLeft)
    ...
    @Override
    public ViewNode[] getChilds(UIViewModel uiModel, VRI locator, int offset, int range, LongHolder numChildsLeft)
            throws ProxyException
    {
