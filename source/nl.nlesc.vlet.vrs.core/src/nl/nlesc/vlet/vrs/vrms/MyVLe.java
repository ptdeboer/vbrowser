...
final public class MyVLe extends VCompositeNode implements VEditable, VLogicalResource, VRenamable, VLogicalFolder
{
    ...
    public VNode addNode(VNode sourceNode, String optNewName, boolean isMove) throws VlException
    {
        ...
        if (isMove)
            throw new nl.nlesc.vlet.exception.NotImplementedException(
    ...
    protected VNode getSubNode(VRL location, boolean recurse) throws VlException
    {
        ...
        if ((location == null) || (location.getScheme().compareTo(VRS.MYVLE_SCHEME) != 0))
            throw new nl.nlesc.vlet.exception.ResourceTypeNotSupportedException("Location is NOT a myvle:// location:"
                    + location);
        ...
        {
            throw new nl.nlesc.vlet.exception.ResourceNotFoundException("Unknown location:" + location);
        }
    ...
    {
        throw new nl.nlesc.vlet.exception.NotImplementedException("Cannot set logical location of 'MyVLe'");
    }
