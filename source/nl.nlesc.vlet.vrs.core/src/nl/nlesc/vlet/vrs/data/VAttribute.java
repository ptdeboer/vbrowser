...
public class VAttribute implements Cloneable, Serializable, Duplicatable<VAttribute>
{
    ...
    protected void init(String name, StringList enumValues, int enumIndex)
    {
        ...
        {
            //errorPrintf("Error enumIndex out of bound:%d\n", enumIndex);
            value = "";
        }
    }
    ...
    public Object getValueObject()
    {
        ...
        try
        {
            switch (this.type)
            {
                ...
                {
                    // OOpsy
                    errorPrintf("***Error: toObject(): Attribute type not supported:%s\n", this);
                    return null;
                }
        ...
        {
            // low level error:
            errorPrintf("***Error: toObject(): Syntax Error for VRL:%s\n", this);
            return null;
        }
        catch (NumberFormatException e)
        {
            // low level error:
            errorPrintf("***Error: toObject(): Syntax Error for:%s\n", value);
            errorPrintf("*** Error: toObject():%s\n", e.getMessage());
            return null;
        ...
        {
            // low level error:
            errorPrintf("***Error: toObject(): Object conversion error for:%s", value);
            errorPrintStacktrace(e);
            return null;
        }
    }
    ...
    protected String _setValue(String val)
    {
        ...
        if (type == VAttributeType.ENUM)
        {
            ...
            this.enumIndex = enumValues.indexOf(value);
        }
    ...
    private void errorPrintStacktrace(Throwable e)
    {
        e.printStackTrace(); 
    }
