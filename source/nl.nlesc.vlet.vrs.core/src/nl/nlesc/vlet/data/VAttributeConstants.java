...
public class VAttributeConstants
{
     ...
     * @see nl.nlesc.vlet.vrs.VNode#getVRL() VNode.getVRL() 
     */  
     ...
     * are allow here. 
     * @see nl.nlesc.vlet.vrs.VNode#getType() VNode.getType() 
     */ 
     ...
     * @see nl.nlesc.vlet.vrs.ServerInfo ServerInfo
     * @see nl.nlesc.vlet.vrs.ServerInfo#GSI_AUTH GSI_AUTH
     * @see nl.nlesc.vlet.vrs.ServerInfo#NO_AUTH NO_AUTH
     */
