...
import nl.nlesc.vlet.dialog.WarningDialog;
...
//    }
     ...
     * certificate store.   
     */
    public static boolean fetchCertificates(CertificateStore cacerts,String host, int port, String optPassphrase,CaCertOptions options)
        throws Exception
    {
    ...
    /** Implementation  */ 
    private static boolean _fetchCertificates(CertificateStore certStore,String host, int port, String optPassphrase,CaCertOptions options)
        throws Exception
    {
        // use defaults; 
    ...
    public static void installCert(String hostname, int port)
    {
        logger.errorPrintf("***FIXME: Install certificate for %s:%d\n",hostname,port); 
    }
