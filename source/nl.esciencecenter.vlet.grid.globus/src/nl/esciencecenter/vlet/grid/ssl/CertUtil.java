...
/**
 * Some useful refactored code from Glite. Loads a proxy and decomposes the
 * Certificate Chain as provided by the Proxy !
 */
...
public class CertUtil
{
    ...
    public Vector<X509Certificate> readCertChain(String certFile) throws IOException
    {
        FileInputStream fis;
        BufferedInputStream bis = new BufferedInputStream(fis=new FileInputStream(certFile));
        
        Vector<X509Certificate> certs = readCertChain(bis);
    ...
    public Vector<X509Certificate> readCertChain(BufferedInputStream stream) throws IOException
    {
        ...
        {
            // logger.warn((new
            // StringBuilder()).append("Invalid certificate chain, certificate unreadable. Cause: ").append(e.getMessage()).toString());
            throw new IOException((new StringBuilder()).append("Invalid certificate chain, certificate unreadable. Cause: ")
