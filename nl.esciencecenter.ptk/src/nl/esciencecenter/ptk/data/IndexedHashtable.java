 ...
 */
public class IndexedHashtable<TK, TV> extends Hashtable<TK,TV>
	implements Iterable<TV>
{
	...
	protected void setKeyVector(Vector<TK> keys,boolean update)
	{
	 ...
	 {
			return new IndexedHashtableIterator<TK,TV>(this); 
	 }
