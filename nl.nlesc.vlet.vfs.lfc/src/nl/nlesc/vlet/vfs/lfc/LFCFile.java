...
import nl.nlesc.vlet.vfs.VGlobalUniqueID;
import nl.nlesc.vlet.vfs.VLinkListable;
        ...
        VLinkListable, VCommentable// , VChecksum
{
            ...
            throws VlException
    {
        ...
        {
            throw new nl.nlesc.vlet.exception.ResourceReadException("File doesn't have any replicas:"+this); 
        }
