 ...
 * ---
 * $Id: VTransferHandler.java,v 1.2 2013/01/23 10:39:58 piter Exp $  
...
public class VTransferHandler extends TransferHandler
{
    ...
    public boolean pasteData(JComponent comp, Transferable data)
	{
    	...
    	else
    	{
    		...
    		UILogger.errorPrintf(this, "--- Import data not supported ---\n Flavors are:\n");
        	
        	for (DataFlavor flav:flavors)
        	{
        		UILogger.errorPrintf(this, " - %s\n",flav);
        	}
    ...
    public boolean interActiveDrop(Component comp, Point point,Transferable data) 
	{
    	...
    	if (vcomp==null) 
    	{
    		UILogger.errorPrintf(this,"doDropOn: Cannot import data to non VComponent:%s\n",comp); 
    		return false;
    	}
    	// next step: 
