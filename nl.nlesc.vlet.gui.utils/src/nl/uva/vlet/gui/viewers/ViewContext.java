 ...
 * ---
 * $Id: ViewContext.java,v 1.4 2013/01/25 11:21:13 piter Exp $  
...
public class ViewContext
{
    ...
    {
        return (StringUtil.isWhiteSpace(properties.get(name))==false); 
    }
	...
	public VRL[] getSelection()
	{
		...
		try
		{
			return VRLList.parseVRLs(uristr);
		}
		catch (Exception e)
		{
			UILogger.logException(this,ClassLogger.ERROR,e,"Failed to parse VRLs:%s\n",uristr); 
			return null;
		} 
	}
