 ...
 * ---
 * $Id: ExceptionForm.java,v 1.3 2013/01/23 10:39:58 piter Exp $  
 * $Date: 2013/01/23 10:39:58 $
 */ 
// source: 

package nl.nlesc.vlet.gui.dialog;
...
public class ExceptionForm extends javax.swing.JDialog implements ActionListener 
{
	...
	public static void show(final Dialog parent,final Throwable e,final boolean modal) 
	{
	...
	private ExceptionForm(Throwable e)
	{
	    super(); 
	    init(e); 
    }
	...
	public ExceptionForm(Dialog parent, Throwable e,boolean modal) 
	{        
