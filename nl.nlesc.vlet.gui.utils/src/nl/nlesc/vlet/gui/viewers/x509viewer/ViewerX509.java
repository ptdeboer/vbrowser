 ...
 * ---
 * $Id: ViewerX509.java,v 1.3 2013/01/25 11:21:13 piter Exp $  
 * $Date: 2013/01/25 11:21:13 $
 */ 
// source: 

package nl.nlesc.vlet.gui.viewers.x509viewer;
...
public class ViewerX509 extends ViewerPlugin implements CertPanelListener
{
    ...
    {
        String txt = UIGlobal.getResourceLoader().getText(loc.toURL(), textEncoding);
