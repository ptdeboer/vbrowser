 ...
 * ---
 * $Id: FontInfo.java,v 1.2 2013/01/23 10:39:58 piter Exp $  
 * $Date: 2013/01/23 10:39:58 $
 */ 
// source: 

package nl.nlesc.vlet.gui.font;
...
public class FontInfo
{
    ...
    private void store()
    {
        ...
        if (autosave==true) 
        {
            ...
            {
                UILogger.logException(this,ClassLogger.ERROR,e,"***Error:when saving font styles:"+e); 
            }    
        }
    }
    ...
    public static FontInfo getFontInfo(String name)
    {
        ...
        if (fontStyles==null) 
        {
            ...
            {
                UILogger.logException(ClassLogger.ERROR,null,e,"***Error: Exception:"+e); 
            }
    ...
    private void saveFontStyles() throws Exception
    {
    ...
    private static void loadFontStyles() throws Exception
    {
    ...
    private static void loadFontStylesFrom(VRL fontLoc) throws Exception
    {
        if (fontStyles==null) 
            fontStyles=new Hashtable<String,FontInfo>();
