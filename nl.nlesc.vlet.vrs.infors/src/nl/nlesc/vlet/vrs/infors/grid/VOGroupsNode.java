 ...
 * ---
 * $Id: VOGroupsNode.java,v 1.1 2013/02/05 11:57:00 piter Exp $  
...
public class VOGroupsNode extends CompositeServiceInfoNode<VONode>
{
            ...
            throws ResourceTypeNotSupportedException
    {
        if ((type == null) || (type.compareTo(InfoConstants.VO_TYPE) != 0))
            throw new nl.nlesc.vlet.exception.ResourceTypeNotSupportedException("Can not create resource type:" + type);
