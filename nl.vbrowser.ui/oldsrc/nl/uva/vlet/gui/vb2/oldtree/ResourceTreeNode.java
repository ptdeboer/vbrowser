 ...
 * ---
 * $Id: ResourceTreeNode.java,v 1.1 2012/11/18 13:20:35 piter Exp $  
...
public class ResourceTreeNode implements MutableTreeNode, VComponent
{
    ...
    public ResourceTreeNode(ResourceTree tree, ViewItem iconItem)
    {
    	init(tree,iconItem);  
    	debug(">>> NEW NODE:"+this);
    }
    
    private void init(ResourceTree tree,ViewItem item)
    {
    ...
    private void init(ViewItem item)
	{
        setUserObject(item);
	...
	public void add(ResourceTreeNode node)
	{
    ...
    public ResourceTreeNode getNode(ProxyLocator vrl)
    {
